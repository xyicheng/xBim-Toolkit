...
namespace CodeExamples.BoundingBox
{
    ...
    {
        //we need to resolve best way forward with geometry
        //Generate Geometry needs to be done once in one place and then the database of geometry should be used
        public void Run()
        {
