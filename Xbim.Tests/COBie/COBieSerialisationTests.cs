...
namespace Xbim.Tests.COBie
{
    ...
    public class COBieSerialisationTests
    {
        ...
        private const string SourceModelLeaf = "Clinic_Handover.xBIM"; //"Clinic_A.xbim";//"2012-03-23-Duplex-Handover.xbim";
        ...
        public void Should_Roundtrip_Serialise()
        {
            ...
            using (XbimModel model = new XbimModel())
            {
                ...
                newBook = deserialiser.Deserialise();
                timer.Stop();
        ...
        public void Should_Have_HashValue_Serialise()
        {
            ...
            using (XbimModel model = new XbimModel())
            {
                ...
                COBieWorkbook book = builder.Workbook;
                hashCode1 = book[Constants.WORKSHEET_FACILITY][0].RowHashValue;
