...
Section "MainSection" SEC01
  ...
  File "..\bin\Release\Esent.Interop.xml"
  File "..\bin\Release\ICSharpCode.SharpZipLib.dll"
  File "..\bin\Release\log4net.dll"
  File "..\bin\Release\log4net.xml"
  SetOutPath "$INSTDIR\PredefinedRules"
  File "..\bin\Release\PredefinedRules\ClassifyModelToNRM.bql"
...
Section Uninstall
  ...
  Delete "$INSTDIR\PredefinedRules\ClassifyModelToNRM.bql"
  Delete "$INSTDIR\log4net.xml"
  Delete "$INSTDIR\log4net.dll"
  Delete "$INSTDIR\ICSharpCode.SharpZipLib.dll"
  Delete "$INSTDIR\Esent.Interop.xml"
