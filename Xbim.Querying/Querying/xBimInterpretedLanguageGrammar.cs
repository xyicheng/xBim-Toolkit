...
namespace Xbim.Querying
{
    ...
    public abstract class xBimInterpretedLanguageGrammar : Grammar , ICanRunSample
    {
        // making the class abstract so it won't load into Grammar Explorer
        public xBimInterpretedLanguageGrammar(bool caseSensitive)
            : base(caseSensitive)
        {
        ...
        public virtual LanguageRuntime CreateRuntime(LanguageData languageData)
        {
            return new LanguageRuntime(languageData);
        }
