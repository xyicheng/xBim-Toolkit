...
namespace Xbim.Ifc.FacilitiesMgmtDomain
{
    ...
    public class IfcConditionCriterion : IfcControl
    {
        ...
        public IfcConditionCriterionSelect Criterion
        {
            ...
            set { ModelManager.SetModelValue(this, ref _criterion, value, v => Criterion = v, "Criterion"); }
        }
        ...
        public IfcDateTimeSelect CriterionDateTime
        {
            ...
            set { ModelManager.SetModelValue(this, ref _criterionDateTime, value, v => CriterionDateTime = v, "CriterionDateTime"); }
        }
