...
namespace Xbim.Ifc.FacilitiesMgmtDomain
{
    /// <summary>
    ...
    public class IfcMove : IfcTask
    {
        ...
        public IfcSpatialStructureElement MoveFrom
        {
            ...
            set { ModelManager.SetModelValue(this, ref _moveFrom, value, v => MoveFrom = v, "MoveFrom"); }
        }
        ...
        public IfcSpatialStructureElement MoveTo
        {
            ...
            set { ModelManager.SetModelValue(this, ref _moveTo, value, v => MoveTo = v, "MoveTo"); }
        }
        ...
        public XbimListUnique<IfcText> PunchList
        {
            ...
            set { ModelManager.SetModelValue(this, ref _punchList, value, v => PunchList = v, "PunchList"); }
        }
