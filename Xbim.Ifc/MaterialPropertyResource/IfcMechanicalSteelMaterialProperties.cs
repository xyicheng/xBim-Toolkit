...
namespace Xbim.Ifc.MaterialPropertyResource
{
    ...
    public class IfcMechanicalSteelMaterialProperties : IfcMechanicalMaterialProperties 
    {
        ...
        public IfcPressureMeasure? YieldStress
        {
            ...
            set { ModelManager.SetModelValue(this, ref _yieldStress, value, v => YieldStress = v, "YieldStress"); }
        }
        ...
        public IfcPressureMeasure? UltimateStress
        {
            ...
            set { ModelManager.SetModelValue(this, ref _ultimateStress, value, v => UltimateStress = v, "UltimateStress"); }
        }
        ...
        public IfcPositiveRatioMeasure? UltimateStrain
        {
            ...
            set { ModelManager.SetModelValue(this, ref _ultimateStrain, value, v => UltimateStrain = v, "UltimateStrain"); }
        }
        ...
        public IfcModulusOfElasticityMeasure? HardeningModule
        {
            ...
            set { ModelManager.SetModelValue(this, ref _hardeningModule, value, v => HardeningModule = v, "HardeningModule"); }
        }
        ...
        public IfcPressureMeasure? ProportionalStress
        {
            ...
            set { ModelManager.SetModelValue(this, ref _proportionalStress, value, v => ProportionalStress = v, "ProportionalStress"); }
        }
        ...
        public IfcPositiveRatioMeasure? PlasticStrain
        {
            ...
            set { ModelManager.SetModelValue(this, ref _plasticStrain, value, v => PlasticStrain = v, "PlasticStrain"); }
        }
        ...
        public XbimSet<IfcRelaxation> Relaxations
        {
            ...
            set { ModelManager.SetModelValue(this, ref _relaxations, value, v => Relaxations = v, "Relaxations"); }
        }
