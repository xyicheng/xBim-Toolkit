...
namespace Xbim.Ifc.MaterialPropertyResource
{
    ...
    public class IfcMechanicalMaterialProperties : IfcMaterialProperties
    {
        ...
        public IfcDynamicViscosityMeasure? DynamicViscosity
        {
            ...
            set { ModelManager.SetModelValue(this, ref _dynamicViscosity, value, v => DynamicViscosity = v, "DynamicViscosity"); }
        }
        ...
        public IfcModulusOfElasticityMeasure? YoungModulus
        {
            ...
            set { ModelManager.SetModelValue(this, ref _youngModulus, value, v => YoungModulus = v, "YoungModulus"); }
        }
        ...
        public IfcModulusOfElasticityMeasure? ShearModulus
        {
            ...
            set { ModelManager.SetModelValue(this, ref _shearModulus, value, v => ShearModulus = v, "ShearModulus"); }
        }
        ...
        public IfcPositiveRatioMeasure? PoissonRatio
        {
            ...
            set { ModelManager.SetModelValue(this, ref _poissonRatio, value, v => PoissonRatio = v, "PoissonRatio"); }
        }
        ...
        public IfcThermalExpansionCoefficientMeasure? ThermalExpansionCoefficient
        {
            ...
            set { ModelManager.SetModelValue(this, ref _thermalExpansionCoefficient, value, v => ThermalExpansionCoefficient = v, "ThermalExpansionCoefficient"); }
        }
