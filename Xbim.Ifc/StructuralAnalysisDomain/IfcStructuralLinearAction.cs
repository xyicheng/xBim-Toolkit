...
// Project:     Xbim.Ifc
// Filename:    IfcStructuralLinearAction.cs
// Published:   01, 2012
...
namespace Xbim.Ifc.StructuralAnalysisDomain
{
    ...
    public class IfcStructuralLinearAction : IfcStructuralAction
    {
        ...
        public override string WhereRule()
        {
            ...
            if (!(AppliedLoad is IfcStructuralLoadLinearForce || AppliedLoad is IfcStructuralLoadTemperature))
                baseErr +=
                    "WR61 StructuralLinearAction : A linear action should place either a linear force or a temperature force. \n";
            return baseErr;
        }
    }
}