...
namespace Xbim.Ifc.ProductExtension
{
    ...
    public class IfcRelServicesBuildings : IfcRelConnects
    {
        ...
        public IfcSystem RelatingSystem
        {
            ...
            set { ModelManager.SetModelValue(this, ref _relatingSystem, value, v => RelatingSystem = v, "RelatingSystem"); }
        }
        ...
        public XbimList<IfcSpatialStructureElement> RelatedBuildings
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _relatedBuildings, value, v => RelatedBuildings = v,
                                           "RelatedBuildings");
            }
        }
