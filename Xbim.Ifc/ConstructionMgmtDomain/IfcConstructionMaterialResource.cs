...
namespace Xbim.Ifc.ConstructionMgmtDomain
{
    ...
    public class IfcConstructionMaterialResource : IfcConstructionResource
    {
        ...
        public XbimSet<IfcActorSelect> Suppliers
        {
            ...
            set { ModelHelper.SetModelValue(this, ref _suppliers, value, v => Suppliers = v, "Suppliers"); }
        }
        ...
        public IfcRatioMeasure? UsageRatio
        {
            ...
            set { ModelHelper.SetModelValue(this, ref _usageRatio, value, v => UsageRatio = v, "UsageRatio"); }
        }
