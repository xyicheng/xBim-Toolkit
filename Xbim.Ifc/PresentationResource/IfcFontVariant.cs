...
{
    [Serializable]
    public struct IfcFontVariant : IFormattable, IPersistIfc, ExpressType
    {
        ...
        public static implicit operator IfcFontVariant(string str)
        {
            return new IfcFontVariant(str);
        }

        /// <summary>
        ///   Ensures only string type is used
        /// </summary>
        public IfcFontVariant(string txt)
        {
            _theValue = txt;
        }
        ...
        public static bool operator ==(IfcFontVariant r1, IfcFontVariant r2)
        {
            return Equals(r1, r2);
        }
        ...
        private static readonly string[] validFontVariants = new[] {"normal", "small-caps"};

        public string WhereRule()
        {
            if (_theValue == null || !validFontVariants.Contains(_theValue.ToLower()))
                return @"WR1 FontVariant : Valid FontWeights are 'normal','small-caps'";
            else
                return "";
        }
