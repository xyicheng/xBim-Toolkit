...
{
    [Serializable]
    public struct IfcTextFontName : IFormattable, IPersistIfc, ExpressType
    {
        ...
        {
            return new IfcTextFontName(str);
        }

        /// <summary>
        ///   Ensures only string type is used
        /// </summary>
        public IfcTextFontName(string txt)
        {
            _theValue = txt;
        }
        ...
        public static bool operator ==(IfcTextFontName r1, IfcTextFontName r2)
        {
            return Equals(r1, r2);
        }
