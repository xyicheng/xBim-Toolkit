...
// Project:     Xbim.Ifc
// Filename:    IfcLuminousFluxMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcLuminousFluxMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcLuminousFluxMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcLuminousFluxMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcLuminousFluxMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcLuminousFluxMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcLuminousFluxMeasure) value).ToString());
            else
