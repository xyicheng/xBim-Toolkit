...
// Project:     Xbim.Ifc
// Filename:    IfcWarpingMomentMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcWarpingMomentMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcWarpingMomentMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcWarpingMomentMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcWarpingMomentMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcWarpingMomentMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcWarpingMomentMeasure) value).ToString());
            else
