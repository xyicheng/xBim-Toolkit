...
// Project:     Xbim.Ifc
// Filename:    IfcElectricCapacitanceMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcElectricCapacitanceMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcElectricCapacitanceMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcElectricCapacitanceMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcElectricCapacitanceMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcElectricCapacitanceMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcElectricCapacitanceMeasure) value).ToString());
            else
