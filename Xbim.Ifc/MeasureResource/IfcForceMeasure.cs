...
{
    [Serializable]
    public struct IfcForceMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcForceMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcForceMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcForceMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcForceMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcForceMeasure) value).ToString());
            else
