...
// Project:     Xbim.Ifc
// Filename:    IfcMomentOfInertiaMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcMomentOfInertiaMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcMomentOfInertiaMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcMomentOfInertiaMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcMomentOfInertiaMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcMomentOfInertiaMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcMomentOfInertiaMeasure) value).ToString());
            else
