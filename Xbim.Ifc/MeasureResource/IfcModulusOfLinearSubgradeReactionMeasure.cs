...
// Project:     Xbim.Ifc
// Filename:    IfcModulusOfLinearSubgradeReactionMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcModulusOfLinearSubgradeReactionMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcModulusOfLinearSubgradeReactionMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcModulusOfLinearSubgradeReactionMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcModulusOfLinearSubgradeReactionMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static bool operator ==(
            IfcModulusOfLinearSubgradeReactionMeasure obj1, IfcModulusOfLinearSubgradeReactionMeasure obj2)
        {
        ...
        public static explicit operator StepP21Token(IfcModulusOfLinearSubgradeReactionMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcModulusOfLinearSubgradeReactionMeasure) value).ToString());
            else
