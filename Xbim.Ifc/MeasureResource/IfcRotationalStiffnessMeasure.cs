...
// Project:     Xbim.Ifc
// Filename:    IfcRotationalStiffnessMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcRotationalStiffnessMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcRotationalStiffnessMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcRotationalStiffnessMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcRotationalStiffnessMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcRotationalStiffnessMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcRotationalStiffnessMeasure) value).ToString());
            else
