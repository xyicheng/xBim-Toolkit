...
// Project:     Xbim.Ifc
// Filename:    IfcMassPerLengthMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcMassPerLengthMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcMassPerLengthMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcMassPerLengthMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcMassPerLengthMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcMassPerLengthMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcMassPerLengthMeasure) value).ToString());
            else
