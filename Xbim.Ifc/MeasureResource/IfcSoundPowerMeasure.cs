...
// Project:     Xbim.Ifc
// Filename:    IfcSoundPowerMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcSoundPowerMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcSoundPowerMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcSoundPowerMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcSoundPowerMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcSoundPowerMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcSoundPowerMeasure) value).ToString());
            else
