...
namespace Xbim.Ifc.ProcessExtensions
{
    ...
    public class IfcScheduleTimeControl : IfcControl
    {
        ...
        public IfcDateTimeSelect ActualStart
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _actualStart, value, v => ActualStart = v,
                                           "ActualStart");
            }
        }
        ...
        public IfcDateTimeSelect EarlyStart
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _earlyStart, value, v => EarlyStart = v,
                                                 "EarlyStart");
            }
        }
        ...
        public IfcDateTimeSelect LateStart
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _lateStart, value, v => LateStart = v,
                                                 "LateStart");
            }
        }
        ...
        public IfcDateTimeSelect ScheduleStart
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _scheduleStart, value, v => ScheduleStart = v,
                                                 "ScheduleStart");
            }
        }
        ...
        public IfcDateTimeSelect ActualFinish
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _actualFinish, value, v => ActualFinish = v,
                                                 "ActualFinish");
            }
        }
        ...
        public IfcDateTimeSelect EarlyFinish
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _earlyFinish, value, v => EarlyFinish = v,
                                                 "EarlyFinish");
            }
        }
        ...
        public IfcDateTimeSelect LateFinish
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _lateFinish, value, v => LateFinish = v,
                                                 "LateFinish");
            }
        }
        ...
        public IfcDateTimeSelect ScheduleFinish
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _scheduleFinish, value, v => ScheduleFinish = v,
                                                 "ScheduleFinish");
            }
        }
        ...
        public IfcTimeMeasure? ScheduleDuration
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _scheduleDuration, value, v => ScheduleDuration = v,
                                                 "ScheduleDuration");
            }
        }
        ...
        public IfcTimeMeasure? ActualDuration
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _actualDuration, value, v => ActualDuration = v,
                                                 "ActualDuration");
            }
        }
        ...
        public IfcTimeMeasure? RemainingTime
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _remainingTime, value, v => RemainingTime = v,
                                                 "RemainingTime");
            }
        }
        ...
        public IfcTimeMeasure? FreeFloat
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _freeFloat, value, v => FreeFloat = v,
                                                 "FreeFloat");
            }
        }
        ...
        public IfcTimeMeasure? TotalFloat
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _totalFloat, value, v => TotalFloat = v,
                                                 "TotalFloat");
            }
        }
        ...
        public IfcBoolean? IsCritical
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _isCritical, value, v => IsCritical = v,
                                                 "IsCritical");
            }
        }
        ...
        public IfcDateTimeSelect StatusTime
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _statusTime, value, v => StatusTime = v,
                                                 "StatusTime");
            }
        }
        ...
        public IfcTimeMeasure? StartFloat
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _startFloat, value, v => StartFloat = v,
                                                 "StartFloat");
            }
        }
        ...
        public IfcTimeMeasure? FinishFloat
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _finishFloat, value, v => FinishFloat = v,
                                                 "FinishFloat");
            }
        }
        ...
        public IfcPositiveRatioMeasure Completion
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _completion, value, v => Completion = v,
                                                 "Completion");
            }
        }
        ...
        public IEnumerable<IfcRelAssignsTasks> ScheduleTimeControlAssigned 
        {
            ...
            {
                return
                    ModelManager.ModelOf(this).InstancesWhere<IfcRelAssignsTasks>(r => r.TimeForTask == this);
            }
        }
