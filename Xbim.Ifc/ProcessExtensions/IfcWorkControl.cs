...
namespace Xbim.Ifc.ProcessExtensions
{
    ...
    public class IfcWorkControl : IfcControl
    {
        ...
        public IfcIdentifier Identifier
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _identifier, value, v => Identifier = v,
                                           "Identifier");
            }
        }
        ...
        public XbimSet<IfcPerson> Creators
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _creators, value, v => Creators = v,
                                           "Creators");
            }
        }
        ...
        public IfcLabel? Purpose
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _purpose, value, v => Purpose = v,
                                           "Purpose");
            }
        }
        ...
        public IfcTimeMeasure? Duration
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _duration, value, v => Duration = v,
                                           "Duration");
            }
        }
        ...
        public IfcDateTimeSelect StartTime
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _startTime, value, v => StartTime = v,
                                           "StartTime");
            }
        }
        ...
        public IfcDateTimeSelect FinishTime
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _finishTime, value, v => FinishTime = v,
                                           "FinishTime");
            }
        }
        ...
        public IfcWorkControlTypeEnum? WorkControlType
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _workControlType, value, v => WorkControlType = v,
                                           "WorkControlType");
            }
        }
        ...
        public IfcLabel? UserDefinedControlType
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _userDefinedControlType, value, v => UserDefinedControlType = v,
