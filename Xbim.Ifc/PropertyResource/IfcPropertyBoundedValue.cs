...
namespace Xbim.Ifc.PropertyResource
{
    ...
    public class IfcPropertyBoundedValue : IfcSimpleProperty
    {
        ...
        public IfcValue UpperBoundValue
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _upperBoundValue, value, v => UpperBoundValue = v,
                                           "UpperBoundValue");
            }
        }
        ...
        public IfcValue LowerBoundValue
        {
            ...
            set
            {
                ModelManager.SetModelValue(this, ref _lowerBoundValue, value, v => LowerBoundValue = v,
                                           "LowerBoundValue");
            }
        }
