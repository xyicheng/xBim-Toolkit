...
namespace Xbim.COBie.Rows
{
    ...
    public class COBieZoneRow : COBieRow
    {
        ...
        [COBieAttributes(4, COBieKeyType.CompoundKey_ForeignKey, "Space.Name", COBieAttributeState.Required_Reference_ForeignKey, "SpaceNames", 255, COBieAllowedType.Text)]
