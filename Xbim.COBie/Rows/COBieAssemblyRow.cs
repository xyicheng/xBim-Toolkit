...
namespace Xbim.COBie.Rows
{
    ...
    public class COBieAssemblyRow : COBieRow
    {
        ...
        [COBieAttributes(3, COBieKeyType.None, "", COBieAttributeState.Required_Reference_PickList, "AssemblyType", 255, COBieAllowedType.AlphaNumeric)]
        public string AssemblyType { get; set; }

        [COBieAttributes(4, COBieKeyType.CompoundKey_ForeignKey, "Component.Name", COBieAttributeState.Required_Reference_PickList, "SheetName", 255, COBieAllowedType.AlphaNumeric)]
        ...
        [COBieAttributes(6, COBieKeyType.None, "", COBieAttributeState.Required_Reference_PrimaryKey, "ChildNames", 255, COBieAllowedType.AlphaNumeric)]
