            ...
            if (!Contacts.ContainsKey(row.Email))
            {
                ...
                if (ValidateString(row.Email))
                {
                    if (ifcTelecomAddress.ElectronicMailAddresses == null)
                        ...
                        ifcTelecomAddress.ElectronicMailAddresses.Add_Reversible(row.Email); //add to existing collection
                }
                ...
                if (ValidateString(row.Category))
                {
                    ...
                    if (ifcPerson.Roles == null)
                        ...
                        ifcPerson.Roles.Add_Reversible(ifcActorRole);//add to existing collection
                }
                //add Company
                ...
                if (ValidateString(row.Phone))
                {
                    if (ifcTelecomAddress.TelephoneNumbers == null)
                        ...
                        ifcTelecomAddress.TelephoneNumbers.Add_Reversible(row.Phone);//add to existing collection
                }
