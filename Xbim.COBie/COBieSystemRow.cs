...
namespace Xbim.COBie
{
    ...
    {
        static COBieSystemRow()
        {
            _columns = new Dictionary<int, COBieColumn>();
            //Properties = typeof(COBieSystem).GetProperties(BindingFlags.Public | BindingFlags.Instance);
            Properties = typeof(COBieSystemRow).GetProperties(BindingFlags.Public | BindingFlags.Instance);
