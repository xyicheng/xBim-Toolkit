<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="model06.aspx.cs" Inherits="Xbim.SceneJSWebViewer.model06" %>
...
<head runat="server">
    ...
    <link href="Styles/ui.dynatree.css" rel="stylesheet" type="text/css" />
     ...
     <script type="text/javascript" src="Scripts/model06.js" ></script>
</head>
<body>
