...
(function () {
    ...
    */
    ...
    NodeSelector.prototype.resetPick = function (canvasX, canvasY, options) {
        return this._targetNode.resetPick(canvasX, canvasY, options);
    }
...
new (function () {
    ...
    */
    ...
    Scene.prototype.resetPick = function (canvasX, canvasY, options) {
        if (this._destroyed) {
            throw SceneJS_errorModule.fatalError(SceneJS.errors.NODE_ILLEGAL_STATE, "Scene has been destroyed");
        }
        options = options || {};
        this.renderFrame();
        return SceneJS_DrawList.resetPick({
            sceneId: this.attr.id,
            canvasX: canvasX,
            canvasY: canvasY
        });
...
var SceneJS_DrawList = new (function () {
    ...
    *----------------------------------------------------------------------------------------------------------------*/
    ...
    this.resetPick = function (params) {
        var states = this._sceneStates[params.sceneId];

        var canvas = states.canvas.canvas;

        canvas.width = params.canvasX;
        canvas.height = params.canvasY;

        if (states.pickBuf) {
            //states.pickBuf.clear();
            states.pickBuf = false;
        }
    }
    /*===================================================================================================================
    *
