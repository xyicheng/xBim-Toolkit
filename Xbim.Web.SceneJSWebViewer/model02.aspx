<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="model02.aspx.cs" Inherits="Xbim.SceneJSWebViewer.model02" %>
...
<head runat="server">
    ...
    <link href="Styles/ui.dynatree.css" rel="stylesheet" type="text/css" />
     ...
     <script type="text/javascript" src="Scripts/model02.js" ></script>
</head>
<body>
