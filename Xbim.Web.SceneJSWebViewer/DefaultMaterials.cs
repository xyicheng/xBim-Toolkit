namespace Xbim.SceneJSWebViewer
{
    ...
    public class DefaultMaterials
    {
        ...
        static DefaultMaterials()
        {
            ...
            _materialMap.Add(typeof(IfcWindow), new Material(StripString(typeof(IfcWindow).ToString()), 0.68, 0.85, 0.90, 0.2, 0));
            _materialMap.Add(typeof(IfcCurtainWall), new Material(StripString(typeof(IfcCurtainWall).ToString()), 0.68, 0.85, 0.90, 0.4, 0));
            _materialMap.Add(typeof(IfcPlate), new Material(StripString(typeof(IfcPlate).ToString()), 0.68, 0.85, 0.90, 0.4, 0));
            _materialMap.Add(typeof(IfcDoor), new Material(StripString(typeof(IfcDoor).ToString()), 0.97, 0.19, 0, 1, 0));
            _materialMap.Add(typeof(IfcSpace), new Material(StripString(typeof(IfcSpace).ToString()), 0.68, 0.85, 0.90, 0.4, 0));
            ...
            _materialMap.Add(typeof(IfcOpeningElement), new Material(StripString(typeof(IfcOpeningElement).ToString()), 0.200000003, 0.200000003, 0.800000012, 0.2, 0));
            _materialMap.Add(typeof(IfcFeatureElementSubtraction), new Material(StripString(typeof(IfcFeatureElementSubtraction).ToString()), 1.0, 1.0, 1.0, 0.0, 0));
        }
