<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="model05.aspx.cs" Inherits="Xbim.SceneJSWebViewer.model05" %>
...
<head runat="server">
    ...
    <link href="Styles/ui.dynatree.css" rel="stylesheet" type="text/css" />
     ...
     <script type="text/javascript" src="Scripts/model05.js" ></script>
</head>
<body>
