...
namespace Xbim
{
	namespace ModelGeometry
	{
		...
		{
			if(dynamic_cast<IfcCartesianTransformationOperator3D^>(tForm))
				...
				return gp_Trsf();
			else if(dynamic_cast<IfcCartesianTransformationOperator3DnonUniform^>(tForm))
				...
				throw (gcnew Exception("XbimGeomPrim. IfcCartesianTransformationOperator3DnonUniform require a specific call"));
			else
