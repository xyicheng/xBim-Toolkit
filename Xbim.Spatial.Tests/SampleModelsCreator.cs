...
namespace Xbim.Spatial.Tests
{
    public class SampleModelsCreator
    {
        ...
        public static XbimModel ColumnsArrayModel(string projectName = "Test model", float height = 500f, float width = 500f, float depth = 500f, float colSpace = 2000f, float rowSpace = 2000f, float layerSpace = 2000f, int colNumber = 4, int rowNumber = 4, int layerNumber = 4)
        {
