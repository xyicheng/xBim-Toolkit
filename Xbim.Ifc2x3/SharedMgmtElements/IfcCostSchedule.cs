...
namespace Xbim.Ifc2x3.SharedMgmtElements
{
    ...
    public class IfcCostSchedule : IfcControl
    {
        public IfcCostSchedule()
            : base()
        {
            _TargetUsers = new XbimSet<IfcActorSelect>(this);
        }
        ...
        private XbimSet<IfcActorSelect> _TargetUsers;
        ...
        public override void IfcParse(int propIndex, IPropertyValue value)
        {
            switch (propIndex)
            {
                ...
                case 8:
                    ...
                    break;
                case 10:
                     _TargetUsers = (XbimSet<IfcActorSelect>)value.EntityVal;
                     break;
                case 11:
        ...
        public void SetTargetUsers(IEnumerable<IfcActorSelect> targetUsers)
        {
            if (_TargetUsers == null) _TargetUsers = new XbimSet<IfcActorSelect>(this);
            else
                _TargetUsers.Clear_Reversible();
            foreach (IfcActorSelect item in targetUsers)
            {
                _TargetUsers.Add_Reversible(item);
            }
        }
