...
// Project:     Xbim.Ifc
// Filename:    IfcElectricCurrentMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcElectricCurrentMeasure : IPersistIfc, IfcMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcElectricCurrentMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcElectricCurrentMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcElectricCurrentMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcElectricCurrentMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcElectricCurrentMeasure) value).ToString());
            else
