...
// Project:     Xbim.Ifc
// Filename:    IfcRotationalFrequencyMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcRotationalFrequencyMeasure : IPersistIfc, IfcDerivedMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcRotationalFrequencyMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcRotationalFrequencyMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcRotationalFrequencyMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcRotationalFrequencyMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcRotationalFrequencyMeasure) value).ToString());
            else
