...
// Project:     Xbim.Ifc
// Filename:    IfcContextDependentMeasure.cs
// Published:   01, 2012
...
{
    [Serializable]
    public struct IfcContextDependentMeasure : IPersistIfc, IfcMeasureValue
    {
        ...
        {
            if (value.HasValue)
                return new IfcContextDependentMeasure((double) value);
            else
        ...
        public static explicit operator double(IfcContextDependentMeasure? obj)
        {
            if (obj.HasValue)
                return ((IfcContextDependentMeasure) obj)._theValue;
            else
                return 0.0;
        }
        ...
        public static explicit operator StepP21Token(IfcContextDependentMeasure? value)
        {
            if (value.HasValue)
                return new StepP21Token(((IfcContextDependentMeasure) value).ToString());
            else
